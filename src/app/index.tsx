...
const BASE_PARKING_SPACES = [
  ...
  },
  {
    ...
    rating: 4.1,
    reviewCount: 4,
    location: 'Camp Lapu-Lapu Vicinity, Lahug, Cebu City',
    description: 'Bakanteng sementadong lote sa tabi ng gate. May bantay na aso at maliwanag sa gabi.',
    amenities: ['Lighting', 'Cement Pavement', 'Pet Friendly'],
    image: 'https://images.unsplash.com/photo-1506521788723-8681148e22db?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle'],
  },
  {
    ...
    rating: 4.4,
    reviewCount: 5,
    location: 'Apasan Road, Lahug, Cebu City',
    description: 'Ligtas na paradahan sa loob ng gate ni Aling Marta. Palaging may tao at CCTV.',
    amenities: ['Gated Property', 'CCTV Monitoring', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1590674899484-d5640e854abe?w=600&auto=format&fit=crop&q=60',
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 14,
    location: 'Salinas Drive Ext, Lahug, Cebu City',
    description: 'Malawak na paradahan sa gilid ng commercial building. Sementado, may guard, at CCTV.',
    amenities: ['Cement Pavement', 'CCTV Monitoring', 'Lighting', '24/7 Security'],
    image: 'https://images.unsplash.com/photo-1573348722427-f1d6819fdf98?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle', 'jeepney', 'truck'],
  },
  {
    ...
    rating: 4.3,
    reviewCount: 3,
    location: 'Sudlon St, Lahug, Cebu City',
    description: 'Simpleng garahe na may canopy. Babantayan ni Lolo Nestor habang nagpapahinga siya sa duyan.',
    amenities: ['Covered Roof', 'Attendant (Lolo Nestor)', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1518005020951-eccb494ad742?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle'],
  },
  {
    ...
    rating: 4.0,
    reviewCount: 6,
    location: 'Upper Lahug, Cebu City',
    description: 'Lupang may graba sa tapat ng duplex. Kasya ang dalawang kotse o jeepney.',
    amenities: ['Lighting', 'Spacious Area'],
    image: 'https://images.unsplash.com/photo-1621905252507-b354bc25edac?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'jeepney'],
  },
  {
    ...
    rating: 4.6,
    reviewCount: 8,
    location: 'La Guardia Ext, Lahug, Cebu City',
    description: 'Ligtas na compound na may sliding gate. Binabantayan ng pamilya ni Tita Linda at may CCTV.',
    amenities: ['Gated Property', 'CCTV Monitoring', 'Lighting', 'Cement Pavement'],
    image: 'https://images.unsplash.com/photo-1545259742-b4fd8fea67e4?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle', 'jeepney', 'truck'],
  },
  {
    ...
    rating: 4.2,
    reviewCount: 4,
    location: 'Salinas Drive Near IT Park, Lahug, Cebu City',
    description: 'Bakanteng lupa na nabakuran ng cyclone wire. Malapit sa IT Park.',
    amenities: ['Gated Property', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1508962914676-134849a727f0?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'jeepney'],
  },
  {
    ...
    rating: 4.8,
    reviewCount: 11,
    location: 'Nivel Hills Road, Lahug, Cebu City',
    description: 'Ligtas na paradahan na may matibay na bubong at steel gate. Katabi ng residential compound.',
    amenities: ['Covered Roof', 'Gated Property', 'CCTV Monitoring', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1520038410233-7141be7e6f97?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle', 'jeepney', 'truck'],
  },
  {
    ...
    rating: 4.0,
    reviewCount: 2,
    location: 'Sudlon Upper, Lahug, Cebu City',
    description: 'Lote na may bakod at gate. Simple ngunit ligtas para sa iyong motorsiklo o kotse.',
    amenities: ['Gated Property', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'jeepney'],
  },
  {
    ...
    rating: 4.5,
    reviewCount: 7,
    location: 'Gorordo Avenue Ext, Lahug, Cebu City',
    description: 'Malilim na paradahan sa ilalim ng malaking canopy sa likod-bahay. May sliding gate.',
    amenities: ['Covered Roof', 'Gated Property', 'Lighting', 'Cement Pavement'],
    image: 'https://images.unsplash.com/photo-1506521788723-8681148e22db?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle', 'jeepney', 'truck'],
  },
  {
    ...
    rating: 4.2,
    reviewCount: 4,
    location: 'Lower Nivel Hills, Lahug, Cebu City',
    description: 'Bakanteng sementadong lote sa tabi ng gate. Bantay-sarado ng pamilya.',
    amenities: ['Gated Property', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1506521788723-8681148e22db?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle'],
  },
  ...
  },
  {
    ...
    rating: 4.3,
    reviewCount: 5,
    location: 'Sudlon Road, Lahug, Cebu City',
    description: 'Sementadong garahe sa harap ng bahay. Kasya ang SUV o dalawang motorsiklo.',
    amenities: ['Covered Roof', 'Lighting', 'Cement Pavement'],
    image: 'https://images.unsplash.com/photo-1573348722427-f1d6819fdf98?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle'],
  },
  {
    ...
    rating: 4.1,
    reviewCount: 3,
    location: 'Beverly Hills Entrance, Lahug, Cebu City',
    description: 'Lugar sa likod-bahay na may graba. May gate at CCTV.',
    amenities: ['CCTV Monitoring', 'Gated Property', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1518005020951-eccb494ad742?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'jeepney'],
  },
  {
    ...
    rating: 4.7,
    reviewCount: 9,
    location: 'Geonzon St Vicinity, Cebu IT Park, Lahug, Cebu City',
    description: 'Sementadong driveway na may bubong at steel sliding gate.',
    amenities: ['Covered Roof', 'Gated Property', 'CCTV Monitoring', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1621905252507-b354bc25edac?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle', 'jeepney', 'truck'],
  },
  {
    ...
    reviewCount: 2,
    location: 'Salinas Drive Ext, Lahug, Cebu City',
    description: 'Bakanteng sementadong espasyo sa tabi ng duplex. Safe at tahimik.',
    amenities: ['Lighting', 'Cement Pavement'],
    image: 'https://images.unsplash.com/photo-1545259742-b4fd8fea67e4?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle'],
  },
  {
    ...
    reviewCount: 7,
    location: 'Apasan Road, Lahug, Cebu City',
    description: 'Saradong garahe sa subdivision. May guards sa entrance ng subdivision.',
    amenities: ['Covered Roof', 'Gated Property', 'Subdivision Security', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1508962914676-134849a727f0?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'jeepney'],
  },
  {
    ...
    rating: 4.0,
    reviewCount: 1,
    location: 'Sudlon Upper Road, Lahug, Cebu City',
    description: 'Malawak at may damuhang lote. Secured ng barbed wire fence at may aso.',
    amenities: ['Pet Friendly', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1520038410233-7141be7e6f97?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle'],
  },
  {
    ...
    rating: 4.6,
    reviewCount: 8,
    location: 'La Guardia Road, Lahug, Cebu City',
    description: 'Malinis na sementadong bakuran na may gate. Katabi ng residential house.',
    amenities: ['Gated Property', 'Lighting', 'Cement Pavement'],
    image: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle', 'jeepney'],
  },
  {
    ...
    reviewCount: 10,
    location: 'Salinas Drive (Near USPF), Lahug, Cebu City',
    description: 'Ligtas na carport na may malaking bubong at steel gate. May CCTV.',
    amenities: ['Covered Roof', 'Gated Property', 'CCTV Monitoring', 'Lighting'],
    image: 'https://images.unsplash.com/photo-1506521788723-8681148e22db?w=600&auto=format&fit=crop&q=60',
    vehicles: ['motorcycle', 'car', 'tricycle', 'bicycle', 'jeepney', 'truck'],
  },
